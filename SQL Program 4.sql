...
SELECT Account.AcctNo, COUNT(*) AS NumCustomers
FROM Account
WHERE Account.Type = 'Joint'
...
-- Query 6
## Write a procedure to find the customer who has highest number of accounts, the customer who has lowest balance, the customer who involved in most of joint accounts. 
DELIMITER //
