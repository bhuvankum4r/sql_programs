## The XYZ Book shop wants keep track of orders of the book. 
## The book is composed of unique id, title, year of publication, single author and single publisher. 
## Each order will be uniquely identified by order-id and may have any number of books. 
## We keep track of quantity of each book ordered.
## We store the following details for author and publisher. 
## AUTHOR: unique author-id, name, city, country 
## PUBLISHER: unique publisher-id, name, city, country. 
## a) Establish the database by normalizing up to 3NF
...
INSERT INTO BOOK (book_id, title, year_of_publication, author_id, publisher_id) VALUES 
(1, 'Harry Potter and the Philosopher\'s Stone', 1997, 1, 1),
 (2, 'Carrie', 1974, 2, 2),
...
INSERT INTO ORDERS (order_id, quantity, cost, date_of_order) VALUES 
(1, 2, 39.98, '2022-02-15'),
 (2, 1, 12.99, '2022-03-05'),
 (3, 3, 29.97, '2022-04-10'),
 (4, 2, 19.98, '2022-04-20');
INSERT INTO ORDERED_BOOKS (order_id, book_id, quantity) VALUES 
(1, 1, 2),
 (1, 3, 1),
 (2, 2, 1),
 (3, 4, 1),
